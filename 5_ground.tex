...
\begin{figure*}
   \centering
\begin{tabular}{cc}
        \includegraphics[width=0.35\paperwidth]{img/5/FilterLossG.pdf}
    & 
        \includegraphics[width=0.35\paperwidth]{img/5/FilterMatchG.pdf}
\end{tabular}
\label{cavity_s_params}
\caption{Cavity filter S-parameters}
\end{figure*}
...
\begin{figure}
    \centering
    \includegraphics[width=0.75\paperwidth]{img/5/lna_schematic.eps}
