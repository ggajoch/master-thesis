...
\begin{figure*}
   \centering
\begin{tabular}{cc}
        \includegraphics[width=0.4\paperwidth]{img/5/lna_pcb.pdf}
    & 
...
\begin{figure}
    \centering
    \includegraphics[width=0.6\paperwidth]{img/5/costasG.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.6\paperwidth]{img/5/symbolsyncG.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.6\paperwidth]{img/5/sensitivityMG.pdf}
    \caption{Costas loop tuning}
